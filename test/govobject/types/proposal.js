...
describe('Proposal', function() {
  ...
  it('should create new proposal', function() {
    ...
    proposal.type = 1;
    proposal.url = "http://www.vkax.xyz";
  ...
  it('should throw error if payment address is P2SH', function() {
    ...
    proposal2.name = 'Proposal-36-VkaxATM';
    ...
    proposal2.type = 1;
    proposal2.url = "https://www.vkaxcentral.org/p/Proposal-36-VkaxATM";
  ...
  it('should parse a serialised datahex proposal', function(){
    ...
    expect(proposal1.url).to.equal('https://www.vkaxcentral.org/p/test_proposal_1519097947');
