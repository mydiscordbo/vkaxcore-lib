 ...
 * ```javascript
 *
 * var uri = new URI('vkax:XsV4GHVKGTjQFvwB7c6mYsGV3Mxf7iser6?amount=1.2');
 ...
 * ```javascript
 *
 * var valid = URI.isValid('vkax:XsV4GHVKGTjQFvwB7c6mYsGV3Mxf7iser6');
 * // true
 * ```
 *
 * @param {string|Object} data - A bitcoin URI string or an Object
...
URI.parse = function(uri) {
  ...
  if (info.protocol !== 'vkax:') {
    throw new TypeError('Invalid vkax URI');
  }
...
URI.prototype._fromObject = function(obj) {
  ...
  if (!Address.isValid(obj.address)) {
    throw new TypeError('Invalid vkax address');
  }
