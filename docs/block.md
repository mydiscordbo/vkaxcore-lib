...
For detailed technical information about a block please visit [Blocks](https://vkax-docs.github.io/en/glossary/block) on the Vkax Wiki.
...
For more information about the specific properties of a block header please visit the [Block headers](https://vkax-docs.github.io/en/developer-reference#block-headers) page on the Vkax Developer Reference Wiki.
