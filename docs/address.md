# Vkax Address
Represents a Vkax address. Addresses are the most popular way to make Vkax transactions. See [the Vkax documentation](https://vkax-docs.github.io/en/glossary/address) for technical background information.
...
The errors are listed in the generated file in the [errors folder](https://github.com/vkaxevo/bitcore-vkax/tree/master/lib/errors). There's a structure to errors defined in the [spec.js file](https://github.com/vkaxevo/bitcore-vkax/tree/master/lib/errors/spec.js).
