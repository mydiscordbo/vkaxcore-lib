...
We're working hard to make *vkaxcore-lib* the most powerful JavaScript library for working with Vkax. Our goal is to have *vkaxcore-lib* be a library that can be used by anyone interested in Vkax, and to level expertise differences with great design and documentation.
